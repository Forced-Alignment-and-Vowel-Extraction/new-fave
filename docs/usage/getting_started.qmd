...
To customize the way `fave-extract corpus` works, including how to incorporate speaker demographics into the output, see [the customization documentation](customization/).
